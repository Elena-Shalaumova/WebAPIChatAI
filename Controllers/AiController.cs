...
namespace WebAPIChatAI.Controllers
{
    ...
    public class AiController : ControllerBase
    {
        ...
        public AiController(ChatAIDB context, OllamaClient ollama, IHttpClientFactory httpClientFactory)
        {
            _context = context;
            _ollama = ollama;
            _httpClient = httpClientFactory.CreateClient();
            _httpClient.BaseAddress = new Uri("http://localhost:11434"); // где крутится Ollama
        }
